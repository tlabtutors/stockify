...
export default function SquareTwo() {
  return (
    <section className="flex flex-col md:max-w-[1200px] m-auto md:flex-row items-center justify-center md:justify-between gap-10 p-12">
      {/* Left Image */}
      ...
      {/* Right Content */}
      <div className="w-full px-10 md:w-1/2 flex justify-center">
        <Image
          src="/images/2.jpg"
